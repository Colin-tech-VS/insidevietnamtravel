...
ITINERARY_15_DAYS_FR = {
    ...
    "overview": (
        ...
        "Au nord : <a href=\"/hanoi\">Hanoï</a>, <a href=\"/sapa\">Sapa</a> et la <a href=\"/halong\">baie d'Halong</a> ; "
        "au centre : <a href=\"/hue\">Huế</a> et <a href=\"/hoi-an\">Hội An</a> ; "
        "au sud : <a href=\"/ho-chi-minh-city\">Ho Chi Minh-Ville</a> et le <a href=\"/delta-du-mekong\">delta du Mékong</a>.</p>"
        "<h2>Combien de jours, meilleure période, budget</h2>"
        "<ul>"
        "<li><strong>Combien de jours</strong> : 15 jours pour ajouter Sapa, Ninh Binh et Huế au classique 10 jours.</li>"
        "<li><strong>Meilleure période</strong> : octobre à avril ; mars–mai pour les rizières vertes à Sapa.</li>"
        "<li><strong>Budget</strong> : 60–95 €/jour sur place selon le confort (hors vol international).</li>"
        "</ul>"
