...
ITINERARY_3_DAYS_EN = {
    ...
    "overview": (
        ...
        "<strong><a href=\"/en/hanoi\">Hanoi</a></strong> (north) — swap <a href=\"/en/halong\">Halong</a> for the "
        "<a href=\"/en/cu-chi\">Cu Chi</a> tunnels if you land in "
        "<a href=\"/en/ho-chi-minh-city\">Ho Chi Minh City</a>.</p>"
        "<h2>How many days, best season, budget</h2>"
        "<ul>"
        "<li><strong>How many days</strong>: 3 days for a city break; 7 days as soon as you want Halong and Hoi An.</li>"
        "<li><strong>Best season</strong>: October to April; avoid heavy northern rain in July–August.</li>"
        "<li><strong>Budget</strong>: €50–120/day depending on comfort (international flights excluded).</li>"
        "</ul>"
